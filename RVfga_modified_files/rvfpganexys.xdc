...
## Buttons
set_property -dict { PACKAGE_PIN N17   IOSTANDARD LVCMOS33 } [get_ports {  i_pbtn[0] }]; # push button center
set_property -dict { PACKAGE_PIN M18   IOSTANDARD LVCMOS33 } [get_ports {  i_pbtn[1] }]; # push button up
set_property -dict { PACKAGE_PIN P17   IOSTANDARD LVCMOS33 } [get_ports {  i_pbtn[2] }]; # push button left
set_property -dict { PACKAGE_PIN M17   IOSTANDARD LVCMOS33 } [get_ports {  i_pbtn[3] }]; # push button right
set_property -dict { PACKAGE_PIN P18   IOSTANDARD LVCMOS33 } [get_ports {  i_pbtn[4] }]; # push button down

## Adding constraints for tri-color LEDs
set_property -dict { PACKAGE_PIN A11   IOSTANDARD LVCMOS33 } [get_ports {  LED_Blue  }]; # Blue LED -- audio
set_property -dict { PACKAGE_PIN D12   IOSTANDARD LVCMOS33 } [get_ports { PWM_AUDIO_0_en }]; #IO_L6P_T0_15 Sch=aud_sd


set_property -dict { PACKAGE_PIN M16   IOSTANDARD LVCMOS33 } [get_ports {  LED_Green }]; # Green LED
set_property -dict { PACKAGE_PIN N15   IOSTANDARD LVCMOS33 } [get_ports {  LED_Red   }]; # Red LED
