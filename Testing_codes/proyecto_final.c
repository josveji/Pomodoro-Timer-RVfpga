...
#define AUDIO_DATA   0x800012C0
#define AUDIO_RELOAD 0x800012C4

static void delayA(volatile uint32_t n) {
...
void alarm_signal(void){
    ...
    // This could involve blinking LEDs, playing a sound, etc.
        ...
        for (int i = 0; i <50000; i++) {
            ...
            delayA(5000);             // ← FUNDAMENTAL
        }
        WRITE32(AUDIO_DATA, 0);
        WRITE32(AUDIO_RELOAD, 0);
}
